...
if(user){
  ...
  fetch(`https://interactive-algorithm-visualizer-11.onrender.com/api/progress/${user.email}`)
    .then(res => res.json())
    .then(progress => {
...
const response = await fetch(
  `https://interactive-algorithm-visualizer-11.onrender.com/api/progress/${user.email}`
);
