...
const algorithmData = {
    ...
    "Two Pointers": {
        description:
        "Uses two indices to efficiently process arrays and strings.",
    ...
    "Sliding Window": {
        description:
        "Maintains a window over a sequence to optimize subarray problems.",
...
{
    name: "Maximum Circular Subarray",
...
"Binary Search on Answer": {
    description:
    "Applies binary search on the answer space instead of array indices.",
...
"Pattern Matching": {
    description:
    "Basic technique to find a pattern inside a text string.",
...
"KMP Algorithm": {
    description:
    "Efficient pattern matching algorithm using LPS array.",
...
"Rabin-Karp": {
    description:
    "Uses hashing to search patterns in strings efficiently.",
...
"Z Algorithm": {
    description:
    "Computes Z-array for efficient pattern matching.",
...
"Min Heap": {
    description:
    "A complete binary tree where the parent is always smaller than its children.",
...
"Max Heap": {
    description:
    "A complete binary tree where the parent is always greater than its children.",
...
"Heapify": {
    description:
    "Converts an array into a heap efficiently.",
...
"DSU": {
    description:
    "Disjoint Set Union efficiently handles connectivity queries.",
...
"Memoization": {
    description:
    "Top-down DP approach that stores results of overlapping subproblems.",
...
"Tabulation": {
    description:
    "Bottom-up DP approach that builds solutions iteratively.",
...
"0/1 Knapsack": {
    description:
    "Chooses items to maximize value without exceeding capacity.",
